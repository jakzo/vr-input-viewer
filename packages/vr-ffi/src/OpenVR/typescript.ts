import { TrackedDeviceProperty_String } from "./TrackedDeviceProperty";

export * from "./TrackedDeviceProperty";

export declare class IVRSystem {
  /**
...
/** Identifies what kind of axis is on the controller at index n.
 */
export enum VRControllerAxisType {
  None = 0,
  TrackPad = 1,
  Joystick = 2,
