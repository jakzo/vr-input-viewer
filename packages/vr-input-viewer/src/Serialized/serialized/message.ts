...
import { Start } from '../serialized/start.js';
import { Stop } from '../serialized/stop.js';
...
start(obj?:Start):Start|null {
  ...
  return offset ? (obj || new Start()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

/**
 * Stop sending input updates
 */
stop(obj?:Stop):Stop|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new Stop()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
